function scr_gene_transfer(parent1_stats,parent2_stats, p1_self,p2_self){
		...
		if p1_self.species >= p2_self.species{
		child.species = p1_self.species}else{child.species = p2_self.species}
		for(i=0; i < array_length(p1_traits_arr)-1; i++){
			...
			child_key = ((p1_value+p2_value)/2)*random_range(0.9,1.1)
